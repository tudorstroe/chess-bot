        ...
        if (curr.getPiece().getColor() == PlayerColor.WHITE) {
            ...
            if (y == 6){
                ...
                if (!tabla.getTabla()[x][y + 1].hasPiece()) {
                    result.add(new Move(queen, tabla.getTabla()[x][y + 1]));
                }

                if (x > 0 && tabla.getTabla()[x - 1][y + 1].hasPiece()
                        && tabla.getTabla()[x - 1][y + 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(queen, tabla.getTabla()[x - 1][y + 1]));
                }

                if (x < 7 && tabla.getTabla()[x + 1][y + 1].hasPiece()
                        && tabla.getTabla()[x + 1][y + 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(queen, tabla.getTabla()[x + 1][y + 1]));
                }
                ...
                if (y < 7 && x > 0 && tabla.getTabla()[x - 1][y + 1].hasPiece()
                        && tabla.getTabla()[x - 1][y + 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(curr.getPiece(), tabla.getTabla()[x - 1][y + 1]));
                }

                if (y < 7 && x < 7 && tabla.getTabla()[x + 1][y + 1].hasPiece()
                        && tabla.getTabla()[x + 1][y + 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(curr.getPiece(), tabla.getTabla()[x + 1][y + 1]));
                }
            ...
            if (y == 1) {
                ...
                if (y > 0 && x > 0 && tabla.getTabla()[x - 1][y - 1].hasPiece()
                        && tabla.getTabla()[x - 1][y - 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(curr.getPiece(), tabla.getTabla()[x - 1][y - 1]));
                }

                if (y > 0 && x < 7 && tabla.getTabla()[x + 1][y - 1].hasPiece()
                        && tabla.getTabla()[x + 1][y - 1].getPiece().getColor() != curr.getPiece().getColor()) {
                    result.add(new Move(curr.getPiece(), tabla.getTabla()[x + 1][y - 1]));
                }
